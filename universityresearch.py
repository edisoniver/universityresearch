...
def max_token(update: Update, context: CallbackContext) -> int:
    user = update.message.from_user
    Keyboard = [
        [
            InlineKeyboardButton('0.0', callback_data='0.0'),
            InlineKeyboardButton('0.1', callback_data='0.0'),
            InlineKeyboardButton('0.2', callback_data='0.0'),
        ], [
            InlineKeyboardButton('0.3', callback_data='0.0'),
            InlineKeyboardButton('0.4', callback_data='0.0'),
            InlineKeyboardButton('0.5', callback_data='0.0'),
        ], [
            InlineKeyboardButton('0.6', callback_data='0.0'),
            InlineKeyboardButton('0.7', callback_data='0.0'),
            InlineKeyboardButton('0.8', callback_data='0.0'),
        ], [ 
            InlineKeyboardButton('0.9', callback_data='0.0'),
            InlineKeyboardButton('1.0', callback_data='0.0'),
    ]
    ]
    reply_markup = InlineKeyboardMarkup(Keyboard)
    logger.info("MAX TOKEN: %d", float(update.message.text))
    update.message.reply_text('---Creativity Value---\n\n0 is definite and factual\n\n1 is creative and different \nPlease select a value: from [0 - 1] \nCommon values: 0.2 - 0.4 - 0.7 - 0.9', reply_markup=reply_markup)
